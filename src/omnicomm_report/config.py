...
# ⚠️ R-INV-8: суммы штрафов НЕ показывать заказчику, пока KOAP_VERIFIED=False —
# номера статей/ставки взяты из агрегаторов и НЕ сверены с adilet.zan.kz.
MRP_KZT = 4325                       # МРП на 2026
KOAP_VERIFIED = False                # стать True только после сверки на adilet
KOAP_REVISION_DATE = None            # дата редакции КоАП после сверки
# ст. 592 КоАП РК (превышение скорости): (нижняя граница превышения км/ч, МРП, статья)
KOAP_SPEEDING = [
    (60, 40, "ст.592 ч.3-1"),        # 60+ км/ч
    (40, 20, "ст.592 ч.3"),          # 40–60
    (20, 10, "ст.592 ч.2"),          # 20–40
    (10, 5,  "ст.592 ч.1"),          # 10–20
]
