...
# Выделенный МЕДЛЕННЫЙ потолок именно для бэкфилла — много ниже лимита аккаунта
# (170/мин), чтобы фоновый забор «капал» и оставлял полосу дневному синку.
TRACK_BACKFILL_RATE_PER_MIN = int(os.getenv("TRACK_BACKFILL_RATE_PER_MIN", "40") or 40)
