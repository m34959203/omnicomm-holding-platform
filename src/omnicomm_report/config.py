...
TERMINAL_STALE_AFTER_MIN = 30        # данных нет > 30 мин → STALE 🟠 (оранжевый)
TERMINAL_OFFLINE_AFTER_HOURS = 24    # данных нет > 24 ч → OFFLINE 🔴 (красный)
# Светофор качества данных (по давности последних данных):
#   🟢 зелёный  ONLINE  — данные ≤ 30 мин назад
#   🟠 оранжевый STALE  — 30 мин … 24 ч назад
#   🔴 красный  OFFLINE — > 24 ч назад
#   ⚪ серый    UNKNOWN — данных в программе нет вообще (нет записи активности)
